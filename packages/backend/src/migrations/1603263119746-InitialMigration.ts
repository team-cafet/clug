...
export class InitialMigration1603263119746 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
      ...
      await queryRunner.query('CREATE TYPE "user_sexe_enum" AS ENUM (\'0\', \'1\', \'2\')');
        ...
        await queryRunner.query('CREATE TABLE "membership_plan" ("id" SERIAL NOT NULL, "price" real NOT NULL, "name" character varying, "type" "membership_plan_type_enum" NOT NULL DEFAULT \'1\', "tacit" boolean NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "clubId" integer, "organisationId" integer NOT NULL, CONSTRAINT "PK_e270c516189a3f2609c413ca451" PRIMARY KEY ("id"))');
