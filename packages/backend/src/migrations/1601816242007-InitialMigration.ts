...
export class InitialMigration1601816242007 implements MigrationInterface {
    name = 'InitialMigration1601816242007'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query('DROP TYPE "user_sexe_enum"');
        await queryRunner.query('DROP TABLE "staff"');
        await queryRunner.query('DROP TABLE "group"');
        await queryRunner.query('DROP TABLE "membership_plan"');
        await queryRunner.query('DROP TYPE "membership_plan_type_enum"');
